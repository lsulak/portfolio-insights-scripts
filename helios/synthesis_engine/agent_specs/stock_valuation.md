...
- **Debt & Cash:** Extract Total Debt and Cash & Equivalents from the `Quantitative Baseline Payload`.
...
- **The Hyper-Growth Reinvestment Anchor (Sales-to-Capital):** 
  ...
  2. If missing, calculate the target company's historical Sales-to-Capital ratio from the `Quantitative Baseline Payload` (`Revenue / (Total Debt + Total Equity - Cash)`). Pick the bigger of the two.
...
- **Relative Valuation:** In the `Sector Analysis Payload` under the header `## Competitive Landscape & Rivalry`, locate the market capitalization, stock price, relative metrics, growth rates and margins. Once done, compare the current multiples **P/S, P/E, P/B, P/FCF, and P/OCF** against the **10-year historical medians** (from `Quantitative Baseline Payload`) for the company. Then, also compare **P/S, P/E, and P/FCF**, revenue growth rates, and profit margins of the company against the top 5 rivals from `Sector Analysis Payload`.
- **Reverse DCF Expectations:** "What FCF CAGR is the market currently pricing in for the next 5 years to justify the current Market Cap?" Compare this Market-Implied Growth against the 10-year historical CAGR and Forward Guidance.
