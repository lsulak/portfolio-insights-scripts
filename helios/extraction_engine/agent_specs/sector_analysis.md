...
- **Competitive Landscape & Rivalry:** Identify the top 3-4 direct competitors to `{{ TICKER }}` within the discovered region. Characterize the market structure (e.g., fragmented, regional oligopoly, global winner-take-all) and recent market share shifts. Is competition rational, or is there a destructive pricing war?
