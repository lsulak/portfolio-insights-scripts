...
- **Format:** Output strictly as a valid Markdown document. You **MUST** use exactly these headers: `## Target Identification & Region`, `## The Capital Cycle & Credit Reality`, `## Value Chain & Pricing Power`, `## Competitive Landscape & Rivalry`, and `## Sector Asymmetrical Risks`.
